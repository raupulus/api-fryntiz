...
/**
 * Resumen del día de la generación de un elemento.
 *
 * Una fila por **elemento y día**, con la misma forma que el de consumo: se
 * suman `energy_wh` y `energy_ah`, y los extremos son de la magnitud
 * instantánea.
 *
 * @property int $id
 ...
 *
 * @method static Builder<static>|HardwarePowerGeneratorToday newModelQuery()
 * @method static Builder<static>|HardwarePowerGeneratorToday newQuery()
 * @method static Builder<static>|HardwarePowerGeneratorToday query()
 *
 * @mixin \Eloquent
 */
