...
use App\Http\Requests\Cv\StoreCvExperienceAccreditedRequest as StoreRequest;
 ...
 */
class CurriculumExperienceAccreditedController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumExperienceAccredited';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvExperienceAccreditedRequest $request
