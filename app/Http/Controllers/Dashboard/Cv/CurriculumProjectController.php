...
use App\Http\Requests\Cv\StoreCvProjectRequest as StoreRequest;
 ...
 */
class CurriculumProjectController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumProject';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvProjectRequest $request
