...
use App\Http\Requests\Cv\StoreCvExperienceSelfEmployedRequest as StoreRequest;
 ...
 */
class CurriculumExperienceSelfEmployedController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumExperienceSelfEmployed';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvExperienceSelfEmployedRequest $request
