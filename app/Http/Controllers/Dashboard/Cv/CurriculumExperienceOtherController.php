...
use App\Http\Requests\Cv\StoreCvExperienceOtherRequest as StoreRequest;
 ...
 */
class CurriculumExperienceOtherController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumExperienceOther';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvExperienceOtherRequest $request
