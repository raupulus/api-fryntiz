 ...
 */
class CurriculumCollaborationController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumCollaboration';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvCollaborationRequest $request
