...
use App\Http\Requests\Cv\StoreCvExperienceNoAccreditedRequest as StoreRequest;
 ...
 */
class CurriculumExperienceNoAccreditedController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumExperienceNoAccredited';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvExperienceNoAccreditedRequest $request
