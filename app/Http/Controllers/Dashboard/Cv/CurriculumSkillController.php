...
use App\Http\Requests\Cv\StoreCvSkillRequest as StoreRequest;
 ...
 */
class CurriculumSkillController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumSkill';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvSkillRequest $request
