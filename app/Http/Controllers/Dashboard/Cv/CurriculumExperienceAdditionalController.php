...
use App\Http\Requests\Cv\StoreCvExperienceAdditionalRequest as StoreRequest;
 ...
 */
class CurriculumExperienceAdditionalController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumExperienceAdditional';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvExperienceAdditionalRequest $request
