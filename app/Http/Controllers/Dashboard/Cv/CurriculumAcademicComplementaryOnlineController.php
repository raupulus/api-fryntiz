 ...
 */
class CurriculumAcademicComplementaryOnlineController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumAcademicComplementaryOnline';
