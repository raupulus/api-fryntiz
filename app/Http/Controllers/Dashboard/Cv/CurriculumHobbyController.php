...
use App\Http\Requests\Cv\StoreCvHobbyRequest as StoreRequest;
 ...
 */
class CurriculumHobbyController extends CurriculumBaseSectionController
{
    public $modelName = '\App\Models\CV\CurriculumHobby';

    /**
     * Almacena un nuevo registro para el usuario actual.
     *
     * @param \App\Http\Requests\Cv\StoreCvHobbyRequest $request
