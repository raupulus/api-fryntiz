...
| `energy:set-nominal-voltage` | Rellena `nominal_voltage` y el rango plausible de los elementos de energía: 24 V al lado del panel, 12 V al de la batería. **Sale en seco**, hay que pedir `--write`. |
