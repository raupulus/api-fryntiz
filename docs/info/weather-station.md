...
| `AEMETOzoneTotal.php` | `meteorology_aemet_ozone_total` | Ozono total diario en superficie (Moguer - El Arenosillo) |
...
| Ozono | AEMET | Último registro de `AEMETOzoneTotal` (`meteorology_aemet_ozone_total`), medición diaria de Moguer - El Arenosillo (`5860E`, ~50 km de Chipiona) |
