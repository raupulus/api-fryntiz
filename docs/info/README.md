...
| [apis/gdacs.md](apis/gdacs.md) | API GDACS | Alertas globales de desastres dentro del radio de Chipiona: sondeo cada 10 min, filtro geográfico, panel de solo lectura |
