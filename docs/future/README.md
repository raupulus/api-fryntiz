...
| [`hardware-vista-dispositivos.md`](hardware-vista-dispositivos.md) | Vista pública de catálogo de dispositivos hardware y telemetría de salud (privacidad estricta por diseño sin IPs) | Sin fecha; no bloquea el despliegue |
