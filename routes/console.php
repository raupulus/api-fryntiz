...
// Verificado en producción (07-09-2026): dry-run de pocos ms, ya no horas.
// `--force` activa el borrado real; solo mira los últimos 15 días, por lo
// que no toca los duplicados históricos anteriores a esta versión (esos se
// limpiaron una vez a mano con `--force --full`).
Schedule::command('keycounter:remove_duplicate', ['--force'])
    ->weeklyOn(1, '03:00')
    ->timezone('Europe/Madrid')
    ->withoutOverlapping()
