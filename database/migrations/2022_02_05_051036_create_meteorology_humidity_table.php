...
/**
 * Class CreateMeteorologyHumidityTable
 */
class CreateMeteorologyHumidityTable extends Migration
{
    private $tableName = 'meteorology_humidity';

    private $tableComment = 'Datos de la humedad del aire';
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            $table->comment('Datos de la humedad del aire');
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->foreign('hardware_device_id')
                ...
                ->onUpdate('CASCADE')
                ->onDelete('CASCADE');
            $table->decimal('value', 14, 4)->comment('Valor medido por el sensor.');
