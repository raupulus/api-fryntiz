...
/**
 * Class CreateMeteorologyPressureTable
 */
class CreateMeteorologyPressureTable extends Migration
{
    private $tableName = 'meteorology_pressure';

    private $tableComment = 'Datos de presión atmosférica';
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            $table->comment('Datos de presión atmosférica');
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
