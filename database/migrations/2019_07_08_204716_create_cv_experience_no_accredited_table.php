...
/**
 * Class CreateCvExperienceNoAccreditedTable
 */
class CreateCvExperienceNoAccreditedTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cv_experience_no_accredited', function (Blueprint $table) {
            $table->comment('Almacena los datos del apartado de experience no accredited para la generación del currículum vitae de los usuarios.');
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
