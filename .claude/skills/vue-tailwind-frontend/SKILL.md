...
`resources/js/` separa responsabilidades: `app.js` (global), `vue.js` (islas
Vue), `alpine.js`, `dashboard/*` (back-office legacy), `components/*`. Mantén ese
reparto; no metas lógica de un dominio en `app.js`.
