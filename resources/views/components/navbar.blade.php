<header class="fixed top-0 w-full z-50 glass-nav shadow-sm" x-data="{ mobileMenuOpen: false }">
    <div class="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto w-full">
        ...
        {{-- Navegación desktop — visible desde lg en adelante --}}
        <nav class="hidden lg:flex items-center gap-5 xl:gap-6">
            <a class="text-on-surface-variant hover:text-on-surface transition-colors font-body text-sm font-bold tracking-tight whitespace-nowrap"
        ...
        {{-- Controles: selector tema + hamburguesa (solo mobile y tablet hasta lg) --}}
        <div class="flex items-center gap-2 shrink-0">
            ...
            {{-- Hamburguesa SOLO en mobile y tablet (oculto en lg+) --}}
    ...
    {{-- Menú mobile desplegable (oculto en lg+) --}}
    <div x-show="mobileMenuOpen"
         x-transition
         class="lg:hidden bg-surface border-t border-outline-variant/15 px-6 py-4 space-y-3">
