...
@section('content')
    <div class="leading-normal tracking-normal"
        ...
        <section class="bg-white border-b">
            ...
            <span id="loader" class="hidden box-map-loader">
            ...
            <progress id="loader_progress" class="loader-progress"></progress>
                    ...
                    <div id="sidebar_container" class="box-information">
                        <div id="sidebar_canvas">
                            <div id="sudo_buttons" class="box-buttons">
                                <div onclick="resetMap();" class="btn-map btn-reset-map pointer">
                                    Reiniciar Zoom
                                </div>
                                ...
                                <div onclick="reloadHistorial();" class="btn-map btn-reload-map pointer">
                                    Recargar datos
                                </div>
                            </div>
                            ...
                            <div id="dump1090_infoblock">
                                <table style="width: 100%">
                                    ...
                                    <tr class="infoblock_body dim">
                                        <td>Selecciona un avión de la tabla inferior para ver sus datos</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr class="infoblock_body">
                                        <td>
                                            Aircraft (total): <span id="dump1090_total_ac">n/a</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="infoblock_body">
                                        ...
                                        <td>
                                            Historial:
                                            <span id="dump1090_total_history">n/a</span> posiciones
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        >
                                    ...
                                    <tr class="infoblock_body">
                                        ...
                                        <td>Última vez Visto: <span id="selected_seen">n/a</span></td>
                                    </tr>
                            ...
                            <div id="planes_table" class="box-table-planes">
                                <table id="tableinfo" class="table-info">
                                    ...
                                    <tr>
                                        ...
                                        <td id="flight" onclick="sortByFlight();">Vuelo</td>
                                        <td
                                            id="squawk"
                                            onclick="sortBySquawk();"
                                        >
                                            Squawk
                                        </td>
                                        <td
                                            id="altitude"
                                            onclick="sortByAltitude();"
                                        >
                                            Altitud ft
                                        </td>
                                        <td
                    ...
                    <div id="SpecialSquawkWarning" class="hidden special-squawk-warning">
                        ...
                        autoridades locales, ya lo saben si es un chillido válido.
                    </div>

                    <div id="update_error" class="hidden update-error">
