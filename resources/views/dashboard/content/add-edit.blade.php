                ...
                <div class="col-12">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade {{$navbarSectionID === 3 ? 'show active' : ''}}" id="nav-contact"
                            ...
                            @includeWhen($model && $model->id, 'dashboard.content.layouts._metadata')
                        </div>
...
@section('css')
    ...
    <link href="{{ mix('css/youtube_video_search.css') }}" rel="stylesheet" />
...
@section('js')
    ...
    <script src="{{mix('dashboard/js/youtube_video_search.js')}}"></script>
