@php
    ...
    if (config('dashboard.theme.aside.theme') === 'light') {
...
<div id="kt_aside" class="aside aside-dark aside-hoverable"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        @if (config('dashboard.theme.aside.minimize') === true)
            {{--begin::Aside toggler--}}
    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper"
        ...
        <div
            ...
            <div class="menu-item">
                <a class="menu-link"
                   href="../../demo1/dist/dashboards/no-toolbar.html">
                                        <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link"
                   href="../../demo1/dist/dashboards/light-aside.html">
                                        <span class="menu-icon">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">Authentication</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div data-kt-menu-trigger="click"
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   href="../../demo1/dist/authentication/flows/basic/password-reset.html">
                                    ...
                                    <span
                                        class="menu-title">Password Reset</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link"
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   ...
                                   target="blank">
                                    ...
                                    <span
                                        class="menu-title">Account Invitation</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link"
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   ...
                                   target="blank">
                                    ...
                                    <span
                                        class="menu-title">Password Changed</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div data-kt-menu-trigger="click"
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   href="../../demo1/dist/modals/general/select-users.html">
                                                        <span
                                                            class="menu-bullet">
                                                            <span
                                                                class="bullet bullet-dot"></span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   href="../../demo1/dist/modals/general/share-earn.html">
                                    ...
                                    <span
                                        class="menu-title">Share &amp; Earn</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">Customers</span>
                                        <span class="menu-arrow"></span>
                                    </span>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">Subscriptions</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">Invoice Manager</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion">
                    <div data-kt-menu-trigger="click"
            ...
            <div data-kt-menu-trigger="click"
                 class="menu-item menu-accordion mb-1">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">User Management</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion">
                    <div data-kt-menu-trigger="click"
            ...
            <div data-kt-menu-trigger="click"
                 class="menu-item menu-accordion mb-1">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">Support Center</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                   href="../../demo1/dist/apps/support-center/tutorials/list.html">
                                    ...
                                    <span
                                        class="menu-title">Tutorials List</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link"
                                   href="../../demo1/dist/apps/support-center/tutorials/post.html">
                                    ...
                                    <span
                                        class="menu-title">Tutorial Post</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span
                                            class="menu-title">File Manager</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
...
<div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
    <a href="../../demo1/dist/documentation/getting-started.html"
       class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip"
