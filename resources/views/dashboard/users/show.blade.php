...
@section('content')
        ...
        <div class="row">
            ...
            <div class="row user-left-part">
                @include('dashboard.users.layouts._sidebar_left')
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4 profile-header-section1 text-right pull-rigth">
                                    @foreach($user->socials as $social)
                                        <a href="{{ $social->url }}"
                                           title="{{ $social->name }}"
                                           style="color: {{ $social->socialNetwork->color }};" >
                                            <i class="{{ $social->socialNetwork->icon }}"></i>
                                        </a>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="tab-content">
                                        @includeWhen($user->data, 'dashboard.users.layouts._content_profile')
                                        @includeWhen($user->details, 'dashboard.users.layouts._content_details')
                                        @include('dashboard.users.layouts._content_social')
                                    </div>
                                </div>

                                @include('dashboard.users.layouts._sidebar_right')
                            </div>
                        </div>
                    </div>
                </div>
